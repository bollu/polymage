...
extern "C" void  pipeline_bilateral(int  cols, int  rows, void * input_void, void * filtered_void)
{
  float * filtered = (float *) filtered_void;  
  ...
  #pragma omp parallel for schedule(static)
  for (int  _T_i1 = -1; (_T_i1 <= 17); _T_i1 = (_T_i1 + 1))
  {
    ...
    memset(interpolated, 0, sizeof(float) * 2 * 128 * 592);
    for (int  _T_i2 = -1; (_T_i2 <= 3); _T_i2 = (_T_i2 + 1))
    {
      for (int  _i0 = 0; (_i0 <= 1); _i0 = (_i0 + 1))
      {
        int  _ct0 = ((136 < ((8 * _T_i1) + 15))? 136: ((8 * _T_i1) + 15));
        int  _ct1 = ((2 > (8 * _T_i1))? 2: (8 * _T_i1));
        for (int  _i1 = _ct1; (_i1 <= _ct0); _i1 = (_i1 + 1))
        {
          int  _ct2 = ((241 < ((64 * _T_i2) + 73))? 241: ((64 * _T_i2) + 73));
      ...
      for (int  _i0 = 0; (_i0 <= 1); _i0 = (_i0 + 1))
      {
        int  _ct4 = ((136 < ((8 * _T_i1) + 14))? 136: ((8 * _T_i1) + 14));
        int  _ct5 = ((2 > ((8 * _T_i1) + 1))? 2: ((8 * _T_i1) + 1));
        for (int  _i1 = _ct5; (_i1 <= _ct4); _i1 = (_i1 + 1))
        {
          int  _ct6 = ((241 < ((64 * _T_i2) + 72))? 241: ((64 * _T_i2) + 72));
      ...
      for (int  _i0 = 0; (_i0 <= 1); _i0 = (_i0 + 1))
      {
        int  _ct8 = ((136 < ((8 * _T_i1) + 12))? 136: ((8 * _T_i1) + 12));
        int  _ct9 = ((2 > ((8 * _T_i1) + 1))? 2: ((8 * _T_i1) + 1));
        for (int  _i1 = _ct9; (_i1 <= _ct8); _i1 = (_i1 + 1))
        {
          int  _ct10 = ((241 < ((64 * _T_i2) + 70))? 241: ((64 * _T_i2) + 70));
      ...
      for (int  _i0 = 0; (_i0 <= 1); _i0 = (_i0 + 1))
      {
        int  _ct12 = ((1079 < ((64 * _T_i1) + 91))? 1079: ((64 * _T_i1) + 91));
        int  _ct13 = ((0 > ((64 * _T_i1) + 12))? 0: ((64 * _T_i1) + 12));
        for (int  _i1 = _ct13; (_i1 <= _ct12); _i1 = (_i1 + 1))
        {
          int  _ct14 = ((1919 < ((512 * _T_i2) + 549))? 1919: ((512 * _T_i2) + 549));
      ...
      int  _ct16 = ((1079 < ((64 * _T_i1) + 79))? 1079: ((64 * _T_i1) + 79));
      int  _ct17 = ((0 > ((64 * _T_i1) + 16))? 0: ((64 * _T_i1) + 16));
      for (int  _i1 = _ct17; (_i1 <= _ct16); _i1 = (_i1 + 1))
      {
        int  _ct18 = ((1919 < ((512 * _T_i2) + 535))? 1919: ((512 * _T_i2) + 535));
...
extern "C" void  pipeline_naive(int  cols, int  rows, void * input_void, void * filtered_void)
{
  float * filtered = (float *) filtered_void;  
  float * input = (float *) input_void;  
  float * grid;
